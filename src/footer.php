                        ...
                        <div class="row justify-content-center ">
                            ...
                            <div class="col-lg-3 col-6 col-md-5 mt-4">
                                <div class="footer__polycies">
                                    ...
                                    <ul>
                                        <li>
                                            <a href=""><i style="width:24px"  class="fa-brands fa-facebook-f"></i> Facebook</a>
                                        </li>
                                        <li>
                                            <a href=""><i style="width:24px"  class="fa-brands fa-twitter"></i> Twitter</a>
                                        </li>
                                        <li>
                                            <a href=""><i style="width:24px"  class="fa-brands fa-pinterest-p"></i> Pinterest</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
