...
<?php 
    ...
    if(!empty($field) && !empty($sort)) {
        $product_category_pagination = $Product->product_category_pagination($category_id,$limit, $start, $field, $sort);
    } else {
        $product_category_pagination = $Product->product_category_pagination($category_id,$limit, $start);
    }
                            ...
                            <div class="list-product">
                                <div class="row">
                                    ...
                                    if(isset($_GET["sizes"])) {
                                        ...
                                        $show_product_filter = $Product->show_product_filter_by_size($size_id,"category_id",$category_id);
                                        ...
                                        <ul class="pagination">
                                            ...
                                            ?>
                                                <li class="page-item">
                                                    ...
                                                    ?>
                                                        <a class="page-link" href="product-category.php?category_id=<?php echo $category_id?>&page=<?php echo $current_page - 1;?>&field=<?php echo $_GET["field"]?>&sort=<?php echo $_GET["sort"]?>" aria-label="Next">
                                                            <span aria-hidden="true">&laquo;</span>
                                                        </a>
                                                    <?php 
                                                        } else {
                                                    ?>
                                                         <a class="page-link" href="product-category.php?category_id=<?php echo $category_id?>&page=<?php  echo $current_page -1; ?>" aria-label="Previous">
                                                        <span aria-hidden="true">&laquo;</span>
                                                    </a>
                                                    <?php 
                                                        }
                                            ...
                                            ?>
                                                <li class="page-item <?php echo $i == $current_page ? "active": ""?>">
                                                    <?php
                                                        if(isset($_GET["field"]) && isset($_GET["sort"])) {
                                                    ?>
                                                        <a class="page-link" href="product-category.php?category_id=<?php echo $category_id?>&page=<?php echo $i ?>&field=<?php echo $_GET["field"]?>&sort=<?php echo $_GET["sort"]?>"><?php echo  $i ?></a>
                                                    <?php 
                                                        } else {
                                                    ?>
                                                        <a class="page-link" href="product-category.php?category_id=<?php echo $category_id?>&page=<?php echo $i ?>"><?php echo  $i ?></a>
                                                    <?php 
                                                        }
                                                    ?>
                                                </li>
                                            ...
                                            ?>
                                                <li class="page-item">
                                                    ...
                                                    ?>
                                                        <a class="page-link" href="product-category.php?category_id=<?php echo $category_id?>&page=<?php echo $current_page + 1;?>" aria-label="Next">
                                                            <span aria-hidden="true">&raquo;</span>
                                                        </a>
                                                    <?php 
                                                        }
