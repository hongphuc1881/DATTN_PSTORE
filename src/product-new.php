...
<?php 
    $Product = new Product;
    $show_product_new = $Product->show_product_new();
    
    $show_size = $Product->show_size();
   
    // phan trang
    // 1.tong so ban ghi
    $total_product = $show_product_new->num_rows;
    ...
    if(!empty($field) && !empty($sort)) {
        $product_new_pagination = $Product->product_new_pagination($limit, $start, $field, $sort);
    } else {
        $product_new_pagination = $Product->product_new_pagination($limit, $start);
    }
                        ...
                        <div class="col-lg-9">
                            <div class="list-product">
                                <div class="row">
                                    ...
                                    if($product_new_pagination) {
                                        while($result = $product_new_pagination->fetch_assoc()) {
                                    ?>
                                        <div class="col-lg-4">
                                            <div class="product-item">
                                                <a href="product-detail.php?product_id=<?php echo $result['product_id']?>">
                                        ...
                                        <ul class="pagination">
                                            ...
                                            ?>
                                                <li class="page-item">
                                                    ...
                                                    ?>
                                                        <a class="page-link" href="product-new.php?page=<?php echo $current_page - 1;?>&field=<?php echo $_GET["field"]?>&sort=<?php echo $_GET["sort"]?>" aria-label="Next">
                                            ...
                                            ?>
                                                <li class="page-item <?php echo $i == $current_page ? "active": ""?>">
                                                    <?php
                                                        if(isset($_GET["field"]) && isset($_GET["sort"])) {
                                                    ?>
                                                        <a class="page-link" href="product-new.php?page=<?php echo $i ?>&field=<?php echo $_GET["field"]?>&sort=<?php echo $_GET["sort"]?>"><?php echo  $i ?></a>
                                                    <?php 
                                                        } else {
                                                    ?>
                                                        <a class="page-link" href="product-new.php?page=<?php echo $i ?>"><?php echo  $i ?></a>
                                                    <?php 
                                                        }
                                                    ?>
                                                </li>
