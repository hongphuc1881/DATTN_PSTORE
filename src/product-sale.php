...
<?php 
    $Product = new Product;
    $show_all_product_sale = $Product->show_product_sale();
    ...
    //6: query
    $product_pagination = $Product->product_sale_pagination($limit, $start);
?>
                                ...
                                <nav aria-label="Page navigation">
                                    <ul class="pagination">
                                        ...
                                        <?php 
                                            for ($i=1; $i <= $page ; $i++) { 
                                        ?>
                                                <li class="page-item <?php echo $i == $current_page ? "active": ""?>"><a class="page-link" href="product-sale.php?page=<?php echo $i ?>"><?php echo  $i ?></a></li>
                                        <?php 
                                                }   
                                        ?>
