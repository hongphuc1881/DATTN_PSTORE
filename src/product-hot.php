...
<?php 
    ...
    // phan trang
    // 1.tong so ban ghi
    $total_product = $show_product_hot->num_rows;
    ...
    if(!empty($field) && !empty($sort)) {
        $product_hot_pagination = $Product->product_hot_pagination($limit, $start, $field, $sort);
    } else {
        $product_hot_pagination = $Product->product_hot_pagination($limit, $start);
    }
  

?>
            <div class="app-container pt-0 pt-sm-5 pt-md-5 pt-lg-5">
                <div class="container ">
                    <div class="row">
                            ...
                            <div class="list-product">
                                <div class="row">
                                    ...
                                    if(isset($_GET["sizes"])) {
                                        ...
                                        $show_product_filter = $Product->show_product_filter_by_size($size_id, "is_hot", 1);
                                    ...
                                    if($product_hot_pagination) {
                                        while($result = $product_hot_pagination->fetch_assoc()) {
                                    ?>
                                        ...
                                        <ul class="pagination">
                                            ...
                                            ?>
                                                <li class="page-item">
                                                    ...
                                                    ?>
                                                        <a class="page-link" href="product-hot.php?page=<?php echo $current_page - 1;?>&field=<?php echo $_GET["field"]?>&sort=<?php echo $_GET["sort"]?>" aria-label="Next">
                                                            <span aria-hidden="true">&laquo;</span>
                                                        </a>
                                                    <?php 
                                                        } else {
                                                    ?>
                                                         <a class="page-link" href="product-hot.php?page=<?php  echo $current_page -1; ?>" aria-label="Previous">
                                                        <span aria-hidden="true">&laquo;</span>
                                                    </a>
                                                    <?php 
                                                        }
                                            ...
                                            ?>
                                                <li class="page-item <?php echo $i == $current_page ? "active": ""?>">
                                                    <?php
                                                        if(isset($_GET["field"]) && isset($_GET["sort"])) {
                                                    ?>
                                                        <a class="page-link" href="product-hot.php?page=<?php echo $i ?>&field=<?php echo $_GET["field"]?>&sort=<?php echo $_GET["sort"]?>"><?php echo  $i ?></a>
                                                    <?php 
                                                        } else {
                                                    ?>
                                                        <a class="page-link" href="product-hot.php?page=<?php echo $i ?>"><?php echo  $i ?></a>
                                                    <?php 
                                                        }
                                                    ?>
                                                </li>
                                            ...
                                            ?>
                                                <li class="page-item">
                                                    ...
                                                    ?>
                                                        <a class="page-link" href="product-hot.php?page=<?php echo $current_page + 1;?>" aria-label="Next">
                                                            <span aria-hidden="true">&raquo;</span>
                                                        </a>
                                                    <?php 
                                                        }
