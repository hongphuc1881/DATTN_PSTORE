...
<?php 
    $Product = new Product;
    $show_all_product_sale = $Product->show_product_hot();


    // phan trang
    // 1.tong so ban ghi
    $total_product = $show_all_product_sale->num_rows;
    ...
    //6: query
    $product_pagination = $Product->product_hot_pagination($limit, $start);
?>
                                ...
                                <nav aria-label="Page navigation">
                                    <ul class="pagination">
                                        ...
                                        <?php 
                                            for ($i=1; $i <= $page ; $i++) { 
                                        ?>
                                                <li class="page-item <?php echo $i == $current_page ? "active": ""?>"><a class="page-link" href="product-hot.php?page=<?php echo $i ?>"><?php echo  $i ?></a></li>
                                        <?php 
                                                }   
                                        ?>
